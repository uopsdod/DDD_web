...
*/
(function(h) { "function" === typeof define && define.amd ? define(["jquery"], function(D) {
        return h(D, window, document) }) : "object" === typeof exports ? module.exports = function(D, I) { D || (D = window);
        I || (I = "undefined" !== typeof window ? require("jquery") : require("jquery")(D));
        return h(I, D, D.document) } : h(jQuery, window, document) })(function(h, D, I, k) {
    function X(a) {
        var b, c, d = {};
        h.each(a, function(e) {
    ...
    function K(a, b, c) { a._hungarianMap || X(a);
        var d;
    ...
    function ma(a, b) {
        ...
        return b.map(function(b, e) { c = Ia(a, e);
                ...
                if ("" !== f) {
                    ...
                    for (var i = 0, n = j.length; i < n; i++) { f = j[i].match(ba);
                        ...
                        if (f) { j[i] = j[i].replace(ba, ""); "" !== j[i] && (a = a[j[i]]);
                            ...
                            a = "" === a ? g : g.join(a);
                            break } else if (g) { j[i] = j[i].replace(U, "");
                            a = a[j[i]]();
                            continue }
    ...
    function nb(a) {
        ...
        for (var f = a.sDom.split(""), g, j, i, n, l, q, t = 0; t < f.length; t++) {
            ...
            if ("<" == j) {
                ...
                n = f[t + 1];
                if ("'" == n || '"' == n) { l = "";
                    for (q = 2; f[t + q] != n;) l += f[t + q], q++; "H" == l ? l = b.sJUIHeader : "F" == l && (l = b.sJUIFooter); - 1 != l.indexOf(".") ? (n = l.split("."), i.id = n[0].substr(1, n[0].length - 1), i.className = n[1]) : "#" == l.charAt(0) ? i.id = l.substr(1, l.length - 1) : i.className = l;
                    t += q }
                e.append(i);
                e = h(i)
    ...
    function pb(a) {
        ...
        h(a.nTable).on("search.dt.DT", function(b, c) {
            if (a === c) try { i[0] !== I.activeElement && i.val(e.sSearch) } catch (d) {} });
        return b[0]
    }
        ...
        f.p || (b.id = a.sTableId + "_paginate", a.aoDrawCallback.push({ fn: function(a) {
                if (d) {
                    var b = a._iDisplayStart,
                        ...
                        h = c(b, i),
                        k, l = 0;
                    for (k = f.p.length; l < k; l++) Na(a, "pageButton")(a, f.p[l], l, h, b, i) } else c.fnUpdate(a, e) }, sName: "pagination" }));
        return b
    }
    ...
    function ka(a) {
        ...
        if (a.scrollBarVis !== v && a.scrollBarVis !== k) a.scrollBarVis = v, Y(a);
            ...
            J(function(a, b) {
                if (h.inArray(a, s) !== -1) a.style.width = z[b] }, o);
            h(v).height(0);
            ...
            if (F.outerWidth() < f) { P = j.scrollHeight > j.offsetHeight || "scroll" == l.css("overflow-y") ? f + b : f;
    ...
    function db(a) { h.each({ num: function(b) {
                return za(b, a) }, "num-fmt": function(b) {
                return za(b, a, Xa) }, "html-num": function(b) {
                return za(b, a, Aa) }, "html-num-fmt": function(b) {
                return za(b, a, Aa, Xa) } }, function(b, c) { v.type.order[b + a + "-pre"] = c;
                ...
                if ("table" !=
                    ...
                    for (j = t.length; g < j; g++) {
                        ...
                        if (p.nTable == this || p.nTHead.parentNode == this || p.nTFoot && p.nTFoot.parentNode == this) {
                            ...
                            if (e.bDestroy !== k ? e.bDestroy : l.bDestroy) { p.oInstance.fnDestroy();
                                break } else {
                                L(p, 0, "Cannot reinitialise DataTable", 3);
                                return
                            }
                        }
                        if (p.sTableId == this.id) { t.splice(g, 1);
                            break }
                    }
                    ...
                    var g = o.asStripeClasses,
                        ...
                        return v.hasClass(a) })) && (h("tbody tr", this).removeClass(g.join(" ")), o.asDestroyStripes = g.slice());
                    t = [];
                    g = this.getElementsByTagName("thead");
                    0 !== g.length && (da(o.aoHeader, g[0]), t = qa(o));
                    if (null === e.aoColumns) { p = [];
                        g = 0;
                        for (j = t.length; g < j; g++) p.push(null) } else p = e.aoColumns;
                    g = 0;
                    for (j =
    ...
    r.register = p = function(a, b) {
        if (h.isArray(a))
            ...
            for (var e = a.split("."), f = Tb, g, j, c = 0, d = e.length; c < d; c++) { g = (j = -1 !== e[c].indexOf("()")) ? e[c].replace("()", "") : e[c];
                var i;
                a: { i = 0;
    ...
    p("page.len()", function(a) {
        return a === k ? 0 !== this.context.length ? this.context[0]._iDisplayLength : k : this.iterator("table", function(b) { Ra(b, a) }) });
    ...
    var $a = function(a, b, c, d, e) {
            ...
            i = 0;
            for (n = b.length; i < n; i++) { j = b[i] && b[i].split ? b[i].split(",") : [b[i]];
                l = 0;
    ...
    p("rows().data()", function() {
        return this.iterator(!0, "rows", function(a, b) {
            return ha(a.aoData, b, "_aData") }, 1) });
    s("rows().cache()", "row().cache()", function(a) {
        return this.iterator("row", function(b, c) {
            var d = b.aoData[c];
            return "search" === a ? d._aFilterData : d._aSortData }, 1) });
    s("rows().invalidate()", "row().invalidate()", function(a) {
        return this.iterator("row", function(b, c) { ca(b, c, a) }) });
            ...
            if (c.length && a.length) {
                ...
                if (d._details) {
                    ...
                    0 < G(g, "_details").length && (f.on("draw.dt.DT_details",
                        ...
                        if (e === b)
                            for (var c, d = aa(b), f = 0, h = g.length; f < h; f++) c = g[f], c._details && c._details.children("td[colspan]").attr("colspan", d) }), f.on("destroy.dt.DT_details", function(a, b) {
                        if (e === b)
    ...
    p(["row().child.show()", "row().child().show()"], function() { Vb(this, !0);
        return this });
    p(["row().child.hide()", "row().child().hide()"], function() { Vb(this, !1);
        return this });
    ...
    s("columns().cache()", "column().cache()",
        function(a) {
            return this.iterator("column-rows", function(b, c, d, e, f) {
                return ha(b.aoData, f, "search" === a ? "_aFilterData" : "_aSortData", c) }, 1) });
    s("columns().nodes()", "column().nodes()", function() {
        return this.iterator("column-rows", function(a, b, c, d, e) {
            return ha(a.aoData, e, "anCells", b) }, 1) });
    ...
    p("cells()", function(a, b, c) {
        ...
        if (null === b || b === k) return this.iterator("table", function(b) {
            ...
            return $a("cell", d, function(a) {
                ...
                if (a === null || a === k || c) { m = [];
                    p = 0;
                    for (r = g.length; p < r; p++) { l = g[p];
                        for (u = 0; u < n; u++) { v = { row: l, column: u };
                            if (c) { s = f[l];
                                a(v, B(b, l, u), s.anCells ? s.anCells[u] : null) && m.push(v) } else m.push(v) } }
                    return m }
    ...
    s("cells().indexes()", "cell().index()", function() {
        return this.iterator("cell", function(a,
            b, c) {
            return { row: b, column: c, columnVisible: $(a, c) } }, 1)
    });
    ...
    p("order.listener()", function(a, b, c) {
        return this.iterator("table", function(d) { Ma(d, a, b, c) }) });
    ...
    p("search()", function(a, b, c, d) {
        var e = this.context;
        return a === k ? 0 !== e.length ? e[0].oPreviousSearch.sSearch : k : this.iterator("table", function(e) { e.oFeatures.bFilter && fa(e, h.extend({}, e.oPreviousSearch, { sSearch: a + "", bRegex: null === b ? !1 : b, bSmart: null === c ? !0 : c, bCaseInsensitive: null === d ? !0 : d }), 1) }) });
    ...
    p("state.save()", function() {
        return this.iterator("table", function(a) { wa(a) }) });
    ...
    p("data()", function() {
        return this.iterator("table", function(a) {
            return G(a.aoData, "_aData") }).flatten() });
    ...
    m.defaults = {
        ...
        oLanguage: {
            ...
            oPaginate: { sFirst: "First", sLast: "Last", sNext: "下一頁", sPrevious: "上一頁" },
            sEmptyTable: "查無資料",
            sInfo: "顯示第 _START_ 筆至第 _END_ 筆，共 _TOTAL_ 筆",
            sInfoEmpty: "顯示第 0 筆至第 0 筆，共 0 筆",
            sInfoFiltered: "(總共 _MAX_ 筆，查詢到 _TOTAL_ 筆)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
    ...
    h.extend(m.ext.type.detect, [function(a, b) {
        ...
        var c = b.oLanguage.sDecimal;
        return Rb(a, c) ? "html-num" + c : null }, function(a, b) {
        var c = b.oLanguage.sDecimal;
        return Rb(a, c, !0) ? "html-num-fmt" + c : null }, function(a) {
