...
public class Util_psw {
	public static String random() {
		Random r = new Random();
		int downCase = r.nextInt(26) + 97;// 得到97-122的隨機數
		String paw = String.valueOf((char) downCase) + r.nextInt(1000000) + 1;
	...
	public static String key_open(String account){
		...
		public static void sendMail(String to, String subject, String messageText) {
	       ...
	       // ●須將myGmail的【安全性較低的應用程式存取權】打開
		     final String myGmail = "ck001583219@gmail.com";
		     final String myGmail_password = "7gla4r8a";
