...
public class Testing_yo extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		// out.println(dao3.findByPrimaryKey(myMemChatVO.getMemChatChatId(),
		// myMemChatVO.getMemChatMemId(), myMemChatVO.getMemChatDate())+"<br>");
		// MemChatService daoServ3 = new MemChatService();
		// out.println("<b>MemChatService-OK: </b>");
		// out.println(daoServ3.findByPrimaryKey(myMemChatVO.getMemChatChatId(),
		// myMemChatVO.getMemChatMemId(), myMemChatVO.getMemChatDate())+"<br>");
		...
		// out.println(dao9.findByPrimaryKey("1000000001").getMemRepContent() +
		// "<br>");
		// out.println(dao9.findByPrimaryKey("1000000001").getMemRepMemVO().getMemName()
		// + "<br>");
		// out.println(dao9.findByPrimaryKey("1000000001").getMemRepOrdVO().getOrdRatingContent()
		// + "<br>");
		// out.println(dao9.findByPrimaryKey("1000000001").getMemRepHotelVO().getHotelOwner()
		// + "<br>");
		// out.println(dao9.findByPrimaryKey("1000000003").getMemRepEmpVO().getEmpName()
		// + "<br>");
		// out.println("<br>---------------------------------------------<br>");
		// 新增測試:
		...
		// out.println(myVO.getMemRepId() + ": " + myVO.getMemRepContent() +
		// "<br>");
		// }
		// out.println("---------------------------------------------<br>");
		// 萬用查詢測試:
		...
		// sessionFactory.getClassMetadata(HotelVO.class);
		...
		// Criteria query =
		// sessionFactory.getCurrentSession().createCriteria(myVOClass);
		...
		// MemChatService dao_memChat = new MemChatService();
		// List<MemChatVO> myList =
		// dao_memChat.getNewestMsgEachChatId("10000001");
		...
		// Chat - Hibernate - chatMemChats Set測試:
		// ChatService dao_chat = new ChatService();
		// Set<MemChatVO> memChatSet =
		// dao_chat.getOneChat("10000001").getChatMemChats();
		// for (MemChatVO myVO: memChatSet){
		// out.println(myVO.getMemChatContent() + "<br>");
		// }
		// MemChat - Hibernate - getChatVOBtwnTwoMems:
//		MemChatService dao_memChat = new MemChatService();
