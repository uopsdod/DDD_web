	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if ("secess".equals(action)) { // 來自listAllEmp.jsp的請求
			...
			try {
				...
				Util_psw.sendMail(hotel.getHotelAccount(),"您好在DDD公司的註冊資料通過", "感謝你的註冊"+request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+"/DDD_web/frontend_hotel/hotel/loginhotel.jsp");
				/***************************
				 * 3.查詢完成,準備轉交(Send the Success view)
				 ************/
		...
		if ("nosecess".equals(action)) { // 來自listAllEmp.jsp的請求
			...
			try {
				...
				Util_psw.sendMail(hotel.getHotelAccount(),"您好在DDD公司的註冊資料尚未通過",other+request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+"/DDD_web/frontend_hotel/hotel/loginhotel.jsp"+"煩請修改資料謝謝您。");
				/***************************
				 * 3.查詢完成,準備轉交(Send the Success view)
				 ************/
