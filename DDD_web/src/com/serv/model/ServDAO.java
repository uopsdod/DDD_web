...
public class ServDAO implements ServDAO_interface{
	...
	public void insert(ServVO aServVO) {
		...
		try{
			...
			pstmt = con.prepareStatement(ServDAO.INSERT_STMT);
	...
	public void update(ServVO aServVO) {
		...
		try{
			...
			con = ds.getConnection();
			pstmt = con.prepareStatement(ServDAO.UPDATE);
	...
	public void delete(String aServVO) {
		...
		try{
			...
			con = ds.getConnection();
			pstmt = con.prepareStatement(ServDAO.DELETE);
	...
	public ServVO findByPrimaryKey(String aServVO) {
		...
		try{
			...
			con = ds.getConnection();
			pstmt = con.prepareStatement(ServDAO.GET_ONE_STMT);
	...
	public List<ServVO> getAll() {
		...
		try{
			...
			con = ds.getConnection();
			pstmt = con.prepareStatement(ServDAO.GET_ALL_STMT);
			rs = pstmt.executeQuery();
