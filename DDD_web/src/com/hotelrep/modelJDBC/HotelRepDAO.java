...
public class HotelRepDAO implements HotelRepDAO_interface {
...
//	String passwd = "tiger";
	...
	public int insert(HotelRepVO aHotelRepVO){
		...
		try {
			...
			pstmt = con.prepareStatement(HotelRepDAO.INSERT);
	...
	public int update(HotelRepVO aHotelRepVO){
		...
		try {
			con = ds.getConnection();
			pstmt = con.prepareStatement(HotelRepDAO.UPDATE);
	...
	public int delete(String aHotelRepId){
		...
		try {
			con = ds.getConnection();
			pstmt = con.prepareStatement(HotelRepDAO.DELETE);
	...
	public List<HotelRepVO> getAll(){
		...
		try {
			con = ds.getConnection();
			pstmt = con.prepareStatement(HotelRepDAO.GET_ALL);
	...
	public List<HotelRepVO> getAllByHotelRepStatus(String aHotelRepStatus){
		...
		try {
			con = ds.getConnection();
			pstmt = con.prepareStatement(HotelRepDAO.GET_ALL_HOTELREPSTATUS);
	...
	public HotelRepVO findByPrimaryKey(String aHotelRepId){
		...
		try {
			con = ds.getConnection();
			pstmt = con.prepareStatement(HotelRepDAO.GET_ONE);
			pstmt.setString(1, aHotelRepId);
			rs = pstmt.executeQuery();
